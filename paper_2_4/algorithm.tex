...
% and each block lagged by one sample
% with $y_{-1}$ and $y_{-2}$ inserted ahead, e.g., $\bm{Y_p}^T[0] = \left[y_{-1} ~ y_{M-1} \cdots y_{M^2-M-1} \right]^T$. 
...
\begin{figure}[t]
    \centerline{\includegraphics[width=3.15in]{recursive_doubling.png}}
