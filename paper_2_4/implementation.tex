...
\begin{table}[t]
    ...
    function name & FMA & shuffle & broadcast & load \\ [0.3ex] % inserts table
...
Assume we implement the algorithms on software. Note normally, the load and broadcast operation are cheap, and moreover,
